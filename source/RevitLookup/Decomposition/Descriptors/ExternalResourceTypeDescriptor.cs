...
/// <summary>
///     Represents the <see cref="Autodesk.Revit.DB.ExternalResourceType" /> exposed to LookupEngine.
/// </summary>
/// <param name="externalResourceType">The external resource type to expose.</param>
