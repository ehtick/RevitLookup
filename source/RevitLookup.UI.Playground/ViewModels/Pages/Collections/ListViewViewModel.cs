...
/// <summary>
///     Represents the sample data for the list view gallery page.
/// </summary>
[UsedImplicitly]
public sealed partial class ListViewViewModel : ObservableObject
{
    ...
    /// <summary>
    ///     Gets the selection mode applied to the list view.
    /// </summary>
    [ObservableProperty]
    public partial SelectionMode SelectionMode { get; private set; } = SelectionMode.Single;

    /// <summary>
    ///     Gets or sets the sample people shown in the list view.
    /// </summary>
    [ObservableProperty]
