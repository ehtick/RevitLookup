...
/// <summary>
///     Represents a Playground mock of <see cref="ICurveLoopVisualizationViewModel" /> that fabricates its initial values with <c>Bogus</c> and no-ops the visualization server.
/// </summary>
[UsedImplicitly]
public sealed partial class MockCurveLoopVisualizationViewModel : ObservableObject, ICurveLoopVisualizationViewModel
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="MockCurveLoopVisualizationViewModel" /> class with fake appearance settings.
    /// </summary>
